    ...
    <cs:molecularCalculation>
        <cs:quantumMechanics>
            <cs:singleReferenceState>
                <cs:multipleDeterminant>
                    <cs:ccsd-t spinType="cs:RHF" basisSet="bse:STO-3G" methodology="cs:normal">
                        <cs:energies unit="cs:eV">
                            <cs:energy type="cs:totalPotential">-1998.65211517</cs:energy>
                            <cs:energy type="cs:correlation">-0.395266375558</cs:energy>
                        </cs:energies>
                    </cs:ccsd-t>
                </cs:multipleDeterminant>
            </cs:singleReferenceState>
