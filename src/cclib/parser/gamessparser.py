        ...
        if line[5:11] == "GBASIS":
            ...
            if basnm1 == "STO" :
                if line.split()[2] == "2":
                    ...
                    self.basisname = "STO-3G"
                elif line.split()[2] == "4":
                    self.basisname = "STO-4G"
                elif line.split()[2] == "5":
            ...
            if basnm1 == "N311" :
                ...
                if line.split()[2] == "6" and line.split()[3] == "POLAR=NONE":
                    self.basisname = "6-311G"
            if basnm1 == "CCD" :
                self.basisname = "cc-pVDZ"
            elif basnm1 == "CCT" :
                self.basisname = "cc-pVTZ"
            elif basnm1 == "CCQ" :
                self.basisname = "cc-pVQZ"
            elif basnm1 == "CC5" :
                self.basisname = "cc-pV5Z"
            elif basnm1 == "CC6" :
                self.basisname = "cc-pV6Z"
            if basnm1 == "ACCD" :
                self.basisname = "aug-cc-pVDZ"
            elif basnm1 == "ACCT" :
                self.basisname = "aug-cc-pVTZ"
            elif basnm1 == "ACCQ" :
                self.basisname = "aug-cc-pVQZ"
            elif basnm1 == "ACC5" :
                self.basisname = "aug-cc-pV5Z"
            elif basnm1 == "ACC6" :
                self.basisname = "aug-cc-pV6Z"
